...
// A_STAR
TEST(A_STAR, EX_10_TEST_1) {
    std::map<int, std::vector<std::pair<int, int> > > connections = read_graph("../../examples/10/data.txt");
    std::pair<std::vector<int>, int> expected = read_expected_output("../../examples/10/tests/result_1.txt");
    std::pair<int, int> test_data = get_test_data("../../examples/10/tests/test_1.txt");
