...
// A_STAR
TEST(A_STAR, EX_21_TEST_1) {
    std::map<int, std::vector<std::pair<int, int> > > connections = read_graph("../../examples/21/data.txt");
    std::pair<std::vector<int>, int> expected = read_expected_output("../../examples/21/tests/result_1.txt");
    std::pair<int, int> test_data = get_test_data("../../examples/21/tests/test_1.txt");
