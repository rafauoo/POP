...
// A_STAR
TEST(A_STAR, EX_6_TEST_1) {
    std::map<int, std::vector<std::pair<int, int> > > connections = read_graph("../../examples/6/data.txt");
    std::pair<std::vector<int>, int> expected = read_expected_output("../../examples/6/tests/result_1.txt");
    std::pair<int, int> test_data = get_test_data("../../examples/6/tests/test_1.txt");
