...
// A_STAR
TEST(A_STAR, EX_4_TEST_1) {
    std::map<int, std::vector<std::pair<int, int> > > connections = read_graph("../../examples/4/data.txt");
    std::pair<std::vector<int>, int> expected = read_expected_output("../../examples/4/tests/result_1.txt");
    std::pair<int, int> test_data = get_test_data("../../examples/4/tests/test_1.txt");
...
TEST(A_STAR, EX_4_TEST_2) {
    std::map<int, std::vector<std::pair<int, int> > > connections = read_graph("../../examples/4/data.txt");
    std::pair<std::vector<int>, int> expected = read_expected_output("../../examples/4/tests/result_2.txt");
    std::pair<int, int> test_data = get_test_data("../../examples/4/tests/test_2.txt");
    std::pair<std::vector<int>, int> output = a_star(connections, test_data.first, test_data.second);
    ASSERT_EQ(output.first, expected.first);
    ASSERT_EQ(output.second, expected.second);
}
