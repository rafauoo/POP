...
// A_STAR
TEST(A_STAR, EX_22_TEST_1) {
    std::map<int, std::vector<std::pair<int, int> > > connections = read_graph("../../examples/22/data.txt");
    std::pair<std::vector<int>, int> expected = read_expected_output("../../examples/22/tests/result_1.txt");
    std::pair<int, int> test_data = get_test_data("../../examples/22/tests/test_1.txt");
