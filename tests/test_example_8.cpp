...
// A_STAR
TEST(A_STAR, EX_8_TEST_1) {
    std::map<int, std::vector<std::pair<int, int> > > connections = read_graph("../../examples/8/data.txt");
    std::pair<std::vector<int>, int> expected = read_expected_output("../../examples/8/tests/result_1.txt");
    std::pair<int, int> test_data = get_test_data("../../examples/8/tests/test_1.txt");
